...
(function() {
  ...
  Backbone.Debug = (function() {
    ...
    Debug.prototype._trackObjects = function() {
      this._hookPrototype('Collection', 'constructor', this._onNewInstance);
      this._hookPrototype('Model', 'constructor', this._onNewInstance);
      this._hookPrototype('View', 'constructor', this._onNewInstance);
      return this._hookPrototype('Router', 'constructor', this._onNewInstance);
    };
